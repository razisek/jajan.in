    ...
    <div>
        ...
        <div class="flex items-center">
            ...
            <div class="p-5 w-8/12">
                ...
                <p class="text-xl font-bold mt-4">OVO - 089653232542</p>
                <p class="font-bold mt-2">Rachma Azis</p>
                <p class="text-primary mt-2 cursor-pointer"><i class="bi bi-pencil-square mr-2"></i> Ubah / Tambah Tujuan Penarikan</p>
            </div>
        </div>
    </div>
@endsection
