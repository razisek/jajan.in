            ...
            <div class="flex items-center justify-start">
                ...
                <a href="{{ url('') }}/" class="flex ml-2 md:mr-24">
                    <img src="https://res.cloudinary.com/dgmwbkto1/image/upload/v1687234627/logo_tddyns.png"
                        class="h-8 mr-3" alt="Jajanin Logo" />
                </a>
            </div>
            <div class="flex items-center">
                <a href="{{ route('page.explore') }}">
                    <div class="hidden lg:block lg:pl-3.5 cursor-pointer text-primary py-2">
                        <label for="topbar-search" class="sr-only">Search</label>
                        <div class="flex items-center mt-1 lg:w-96">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 hidden">
                        ...
                        <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{ url('') }}/images/users/bonnie-green.png" alt="Jese image">
                                <div
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full"
                                src="{{ auth()->user()->getFirstMediaUrl('avatar') != ''? auth()->user()->getFirstMediaUrl('avatar'): 'https://ui-avatars.com/api/?background=random&name=' . auth()->user()->name }}"
                                alt="user photo">
                        </button>
                    </div>
