...
<body>
    <div  class="header justify-between p-5 px-24 flex flex-wrap flex-col md:flex-row md:items-center items-center">
        <div class="logo">
            <a href="/"><img src="{{ URL('assets/jajanin_logo2.png')}}" alt="Jajanin Logo"></a>
        </div>
        <div class="menu_navigation">
            <ul class="flex content-center">
                <li ><a class="nav_pad flex" href="/creator_explorer"><img class="search_icon px-2" src="{{ URL('assets/Search_icon.png')}}" alt="">Explorer Creator</a></li>
    ...
    <div class="cta px-24 py-10 justify-between flex flex-wrap flex-col md:flex-row md:items-center items-center">
        <div class="cta_left my-20">
            ...
            <p class="text-lg text-slate-200">Di sini kamu bisa memberikan dukungan dan ikut berkontribusi untuk content creator favorit kamu secara mudah dan menyenangkan dengan jajan.in</p>
            <div class="cta_input flex p-6 mt-20 rounded-full">
                <p class="text-3xl">jajan.in/</p>
                <span><input class="create_input text-3xl bg-purple-800 text-white text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text"></span>
                <button class="lgn_btn text-3xl inline-flex items-center border-0 mx-4 py-2 px-8 focus:outline-none rounded-full text-base mt-4 md:mt-0">Create!
                </button>
            </div>
        </div>
        <div class="cta_right">
            <img class="cta_img px-20" src="{{ URL('assets/cta_img_main.png')}}" alt="">
        </div>
    </div>

    <div style="background-image: url({{ asset('assets/counter_background.png')}}" class="counter rounded-3xl drop-shadow-2xl flex justify-between items-center">
      <div class="flex items-center">
        <img class="counter_img" src="{{ URL('assets/counter_creator.png')}}" alt="">
        <div class="">
      ...
      <div class="flex items-center">
        <img class="counter_img" src="{{ URL('assets/counter_jajanan.png')}}" alt="">
        <div class="">
          <h1 class="counter_count">345.700</h1>
      ...
      <div class="flex items-center">
        <img class="counter_img" src="{{ URL('assets/counter_supporters.png')}}" alt="">
        <div class="">
          <h1 class="counter_count">345.700</h1>
    ...
    <div class="about_us px-24 justify-between flex flex-wrap flex-col md:flex-row md:items-center items-center">
      <div class="about_us_left mr-">
        <img class="pr-6 pl-20" src="{{ URL('assets/aboutus_left.png')}}" alt="">
      </div>
      <div class="about_us_right">
        <div class="about_us_content">
          ...
          <p  class="text-base font-normal pb-3">Jajan.in adalah platform crowdfunding untuk dukungan finansial kepada kreator konten, seniman, dan nirlaba. Para kreator dapat mengumpulkan dana untuk proyek mereka dan memberikan reward kepada pendukung.</p>
        </div>
        <div class="about_us_point flex">
          <img class="aboutus_icon" src="{{ URL('assets/aboutus_donate.png')}}" alt="">
          <div>
        ...
        <div class="about_us_point flex">
          <img class="aboutus_icon" src="{{ URL('assets/aboutus_creator.png')}}" alt="">
          <div>
        ...
        <div class="about_us_point flex">
          <img class="aboutus_icon" src="{{ URL('assets/aboutus_reward.png')}}" alt="">
          <div>
    ...
    <div class="howwork text-center">
      ...
      <h3 class="pt-16 text-xl">Mudah dan aman</h3>
      <div class="howwork_content flex justify-between ">
        <div class="howwork_point text-center">
          <img class="howwork_img mx-auto" src="{{ URL('assets/howwork1.png')}}" alt="">
          <h3 class="howwork_content_title text-3xl font-semibold">Buat Campaign</h3>
          <p class="text-lg">Buat karya terbaik kamu dalam bentuk tulisan, audio, video, dan gambar dan jadikan sebagai reward untuk para supportermu</p>
        </div>
        <img class="howwork_arrow" src="{{ URL('assets/howwork_arrow.png')}}" alt="">
        <div class="howwork_point text-center">
          <img class="howwork_img mx-auto" src="{{ URL('assets/howwork2.png')}}" alt="">
          <h3 class="howwork_content_title text-3xl font-semibold">Bagikan dan raih dukungan</h3>
          <p class="text-lg">Bagikan link karya atau link jajan.in mu di sosial media dan dapatkan dukungan dari supporter kamu.</p>
        </div>
        <img class="howwork_arrow" src="{{ URL('assets/howwork_arrow.png')}}" alt="">
        <div class="howwork_point text-center">
          <img class="howwork_img mx-auto" src="{{ URL('assets/howwork3.png')}}" alt="">
          <h3 class="howwork_content_title text-3xl font-semibold">Cairkan jajan.in</h3>
          <p class="text-lg">Kamu bisa cairkan uang jajan.in kamu ke beragam pilihan rekening dan e-wallet sesuai yang kamu mau.</p>
        </div>
      </div>
    </div>

    <div style="background-image: url({{ asset('assets/why_bg.png')}}" class="why">
      ...
      <div class="why_content px-24 justify-between flex flex-wrap flex-col md:flex-row md:items-center items-center">
        <div class="why_point">
          <img class="why_img mx-auto" src="{{ URL('assets/why_goal.png')}}" alt="">
          <h3 class="why_title text-center text-slate-300 text-2xl font-semibold">Goals</h3>
          <p class=" text-center text-slate-300 text-sm">Buat target penggalangan untuk karya mu, ajak supporter untuk berpartisipasi mewujudkan harapan kamu!</p>
        </div>
        <div class="why_point">
          <img class="why_img mx-auto" src="{{ URL('assets/why_sub.png')}}" alt="">
          <h3 class="why_title text-center text-slate-300 text-2xl font-semibold">Subscription As Supporter</h3>
          <p class=" text-center text-slate-300 text-sm">Ajak supporter berlangganan konten eksklusif mu dan buat penghasilan bulanan!</p>
        </div>
        <div class="why_point">
          <img class="why_img mx-auto" src="{{ URL('assets/why_aiop.png')}}" alt="">
          <h3 class="why_title text-center text-slate-300 text-2xl font-semibold">All-in-One Platform</h3>
          <p class=" text-center text-slate-300 text-sm">Jajan.in untuk semua fitur. Upload karya mu dalam berbagai format: artikel, komik, lagu, foto dan masih banyak lagi!</p>
        </div>
        <div class="why_point">
          <img class="why_img mx-auto" src="{{ URL('assets/why_mf.png')}}" alt="">
          <h3 class="why_title text-center text-slate-300 text-2xl font-semibold">Minimum Fee</h3>
          <p class=" text-center text-slate-300 text-sm">Rasakan manfaat dari trakteer dengan biaya penanganan yang sangat murah, hanya 5%!</p>
        </div>
      </div>
    </div>
    ...
    <div class="trust pb-24">
      ...
      <p class="trust_desk text-lg text-center py-8 mx-auto">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut lab</p>
      ...
      <div class="px-24 pt-12 justify-around flex flex-wrap flex-col md:flex-row md:items-center items-center">
        <div class="testimoni_content">
          <div class="flex">
            <img class="testimoni_img" src="{{ URL('assets/testimoni1.png')}}" alt="">
            <div>
              <div class="testimoni_user flex justify-between pb-2">
                ...
                <a class="flex text-purple-800" href="#">Lihat Halaman Profil <img class="w-6 h-6" src="{{ URL('assets/arrow_icon.png')}}" alt=""></a>
              </div>
              <div class="testimoni_folowers flex justify-around">
                <img class="folowors_cake_img px-1" src="{{ URL('assets/testimoni_cake.png')}}" alt="">
                <p>Dijalanin lebih dari 1.545 kue</p>
              </div>
            </div>
          </div>
          <p class="pt-4">"Saya berterima kasih kepada jajan.in sudah membantu para kreator untuk mendapatkan apresiasi lebih berupa donasi. Tetap sukses trakteer! Thank you for all of your hardworks!"</p>
        </div>
        <div class="testimoni_content">
          <div class="flex">
            <img class="testimoni_img" src="{{ URL('assets/testimoni2.png')}}" alt="">
            <div>
              <div class="testimoni_user flex justify-between pb-2">
                <div>
                  <h1>Vestia Zeta</h1>
          ...
          <p class="pt-4">"Jajan.in itu buatku paling cocok untuk sharing content, jajan.in rame sekalii! Admin fast response pencairan dana dll juga cepat! Sukses terus dan semoga makin rame ya jajan.in!"</p>
        </div>
      </div>
    </div>
    ...
    <div class="qna px-24 py-24">
      ...
      <p class="text-center text-xl py-8">Anda akan menemukan pertanyaan umum di bawah ini, tetapi jika anda ingin tahu lebih banyak, hubungi saja!</p>
      <div class="flex justify-center">
        <div>
          <div class="qna_opsi rounded-full flex justify-between">
            <p class="text-2xl">Pencairan Dana</p>
            <img class="w-6 h-6" src="{{ URL('assets/arrow_icon.png')}}" alt="">
          </div>
          <div class="qna_opsi rounded-full flex justify-between">
